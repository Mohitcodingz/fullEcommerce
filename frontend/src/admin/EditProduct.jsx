...
const EditProduct = () => {
  ...
  return (
    <div className="admin-form-page" style={{ maxWidth: '600px', margin: '40px auto', background: '#18181b', padding: '40px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
